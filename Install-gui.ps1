...
Push-Location
try {
    Set-Location xxch-blockchain-gui
    ...
    Write-Output ""
    Write-Output "Xxch blockchain Install-gui.ps1 completed."
    Write-Output ""
    Write-Output "Type 'cd xxch-blockchain-gui' and then 'npm run electron' to start the GUI."
} finally {
    Pop-Location
}
