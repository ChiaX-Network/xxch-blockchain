...
pip install j2cli
CLI_DEB_BASE="xxch-blockchain-cli_$XXCH_INSTALLER_VERSION-1_$PLATFORM"
mkdir -p "dist/$CLI_DEB_BASE/opt/xxch"
mkdir -p "dist/$CLI_DEB_BASE/usr/bin"
mkdir -p "dist/$CLI_DEB_BASE/DEBIAN"
j2 -o "dist/$CLI_DEB_BASE/DEBIAN/control" assets/deb/control.j2
cp -r dist/daemon/* "dist/$CLI_DEB_BASE/opt/xxch/"

ln -s ../../opt/xxch/xxch "dist/$CLI_DEB_BASE/usr/bin/xxch"
...
if [ "$PLATFORM" = "arm64" ]; then
  ...
  echo USE_SYSTEM_FPM=true npx electron-builder build --linux deb --arm64 \
    ...
    --config.deb.packageName="xxch-blockchain"
...
GUI_DEB_NAME=xxch-blockchain_${XXCH_INSTALLER_VERSION}_${PLATFORM}.deb
mv "dist/${PRODUCT_NAME}-${XXCH_INSTALLER_VERSION}.deb" "../../../build_scripts/dist/${GUI_DEB_NAME}"
