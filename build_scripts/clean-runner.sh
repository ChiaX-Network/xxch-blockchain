...
rm -rf ../venv || true
rm -rf venv || true
rm -rf xxch_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf xxch-blockchain-gui/build || true
rm -rf xxch-blockchain-gui/daemon || true
rm -rf xxch-blockchain-gui/node_modules || true
rm xxch-blockchain-gui/temp.json || true
( cd "$PWD/xxch-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
