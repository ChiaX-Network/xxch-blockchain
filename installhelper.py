...
# Gets the version from the result of "xxch version"
...
def get_xxch_version() -> str:
    version: str = "0.0"
    output = subprocess.run(["xxch", "version"], capture_output=True)
...
if __name__ == "__main__":
    update_version(f"{os.path.dirname(__file__)}/xxch-blockchain-gui/package.json")
    update_version(f"{os.path.dirname(__file__)}/xxch-blockchain-gui/packages/gui/package.json")
