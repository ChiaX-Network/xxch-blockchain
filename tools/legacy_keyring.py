"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of xxch-blockchain. To use this
...
from xxch.util.errors import KeychainUserNotFound
from xxch.util.keychain import KeyData, KeyDataSecrets, get_private_key_user
...
DEFAULT_USER = f"user-xxch-{CURRENT_KEY_VERSION}"  # e.g. user-xxch-1.8
DEFAULT_SERVICE = f"xxch-{DEFAULT_USER}"  # e.g. xxch-user-xxch-1.8
MAX_KEYS = 100
