...
root = here.parent
cache_path = root.joinpath(".xxch_cache", "manage_clvm.json")
...
from xxch.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"xxch"}
hashes_path = root.joinpath("xxch/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("xxch/wallet/puzzles")
...
main(auto_envvar_prefix="XXCH_MANAGE_CLVM")
