...
"""
run_block: Convert an encoded FullBlock from the Xxch blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../xxch/types/full_block.py) in json format
...
$ca_root is the directory containing your current Xxch config files
$hash is the header_hash of the [BlockRecord](../xxch/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../xxch/types/condition_opcodes.py)
...
from xxch.types.condition_with_args import ConditionWithArgs
...
from xxch.wallet.cat_wallet.cat_utils import match_cat_puzzle
