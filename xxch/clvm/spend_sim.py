...
from xxch.consensus.block_rewards import calculate_base_farmer_reward, calculate_pool_reward
from xxch.consensus.coinbase import create_farmer_coin, create_pool_coin
...
from xxch.full_node.mempool import Mempool
...
from xxch.types.blockchain_format.program import INFINITE_COST
...
from xxch.types.mempool_item import MempoolItem
...
"""
The purpose of this file is to provide a lightweight simulator for the testing of Xxchlisp smart contracts.
...
There is also a provided NodeClient object which implements many of the methods from xxch.rpc.full_node_rpc_client
    ...
    async def farm_block(
        ...
        self.block_records.append(
            SimBlockRecord.create(
                [pool_coin, farmer_coin, fees_coin],
                next_block_height,
                self.timestamp,
            )
        )
