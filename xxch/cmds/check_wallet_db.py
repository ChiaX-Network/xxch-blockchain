...
from xxch.util.collection import find_duplicates
from xxch.util.db_synchronous import db_synchronous_on
from xxch.util.db_wrapper import DBWrapper2, execute_fetchone
from xxch.util.pprint import print_compact_ranges
...
help_text = """
\b
    The purpose of this command is find potential issues in Xxch wallet databases.
    The core xxch client currently uses sqlite to store the wallet databases, one database per key.
\b
