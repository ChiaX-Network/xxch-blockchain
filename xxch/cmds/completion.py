...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(xxch complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33mxxch complete generate > ~/.xxch-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.xxch-complete-bash\033[0m
    """
    ...
    subprocess.run(["xxch"], check=True, env={**os.environ, "_XXCH_COMPLETE": f"{shell}_source"})
