...
from xxch.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.xxch.cc"
                testnet_dns_introducer = "dns-introducer-testnet10.xxch.cc"
                bootstrap_peers = ["testnet10-node.xxch.cc"]
                testnet = "testnet10"
                ...
                mainnet_port = "8444"
                mainnet_introducer = "introducer.xxch.cc"
                mainnet_dns_introducer = "dns-introducer.xxch.cc"
                bootstrap_peers = ["node.xxch.cc"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running xxch services for changes to take effect")
