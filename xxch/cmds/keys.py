...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Xxch versions use "
...
@click.option("--prefix", "-x", help="Address prefix (xxch for mainnet, txxch for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
