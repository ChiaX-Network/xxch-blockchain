...
from xxch.daemon.client import acquire_connection_to_daemon
from xxch.util.errors import KeychainMaxUnlockAttempts
from xxch.util.keychain import Keychain, supports_os_passphrase_storage
from xxch.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE, KeyringWrapper
from xxch.util.misc import prompt_yes_no
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Xxch processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("XXCH_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'xxch passphrase set' or 'xxch passphrase remove' to update or remove your passphrase")
        sys.exit(1)
