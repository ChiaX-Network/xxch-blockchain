...
from xxch.cmds.cmds_util import NODE_TYPES
from xxch.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified Xxch service to ip:port", type=str, default="")
@click.option(
