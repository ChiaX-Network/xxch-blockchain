...
from xxch.cmds.passphrase_funcs import get_current_passphrase
from xxch.daemon.client import DaemonProxy, connect_to_daemon_and_validate
from xxch.util.errors import KeychainMaxUnlockAttempts
from xxch.util.keychain import Keychain
from xxch.util.service_groups import services_for_groups
...
async def async_start(root_path: Path, config: Dict[str, Any], group: tuple[str, ...], restart: bool) -> None:
    ...
    if daemon is None:
        print("Failed to create the xxch daemon")
        return None
