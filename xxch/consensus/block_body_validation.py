...
from xxch.full_node.mempool_check_conditions import mempool_check_time_locks
    ...
    if height > 0:
        ...
        if prev_transaction_block_height >= STAKE_FORK_HEIGHT:
            ...
            if prev_transaction_block.fees > 0:
                expected_reward_coins.add(create_fee_coin(
                    prev_transaction_block_height,
            ...
            expected_reward_coins.add(create_farmer_coin(
                prev_transaction_block_height,
                prev_transaction_block.farmer_puzzle_hash,
                uint64(calculate_base_farmer_reward(prev_transaction_block_height) + prev_transaction_block.fees),
                constants.GENESIS_CHALLENGE,
            ))
        ...
        if prev_transaction_block_height > 0:
