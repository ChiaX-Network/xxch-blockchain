...
from xxch.consensus.block_root_validation import validate_block_merkle_roots
...
from xxch.util.generator_tools import tx_removals_and_additions
...
async def validate_block_body(
    ...
    *,
    ...
    # 18. Check that the fee amount + farmer reward + stake reward < maximum coin amount
    if (
        fees + calculate_base_farmer_reward(height) + calculate_stake_farm_reward(height)
