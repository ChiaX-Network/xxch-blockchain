...
from xxch.consensus.difficulty_adjustment import can_finish_sub_and_full_epoch
from xxch.consensus.get_block_challenge import final_eos_is_already_included, get_block_challenge
from xxch.consensus.make_sub_epoch_summary import make_sub_epoch_summary
...
from xxch.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot, SubSlotProofs
...
def validate_unfinished_header_block(
    ...
    if (
        ...
        return None, ValidationError(Err.INVALID_COMMUNITY_PUZZLE_HASH)
