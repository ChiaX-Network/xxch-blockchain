...
from xxch.consensus.block_body_validation import ForkInfo
...
from xxch.types.blockchain_format.vdf import CompressibleVDFField, VDFInfo, VDFProof, validate_vdf
...
class FullNode:
    ...
    _server: Optional[XxchServer] = None
