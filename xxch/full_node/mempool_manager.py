...
from xxch.consensus.block_record import BlockRecordProtocol
from xxch.consensus.constants import ConsensusConstants
from xxch.consensus.cost_calculator import NPCResult
from xxch.full_node.bitcoin_fee_estimator import create_bitcoin_fee_estimator
from xxch.full_node.bundle_tools import simple_solution_generator
from xxch.full_node.fee_estimation import FeeBlockInfo, MempoolInfo, MempoolItemInfo
from xxch.full_node.fee_estimator_interface import FeeEstimatorInterface
from xxch.full_node.mempool import MEMPOOL_ITEM_FEE_LIMIT, Mempool, MempoolRemoveReason
from xxch.full_node.mempool_check_conditions import get_name_puzzle_conditions, mempool_check_time_locks
from xxch.full_node.pending_tx_cache import ConflictTxCache, PendingTxCache
from xxch.types.blockchain_format.coin import Coin
from xxch.types.blockchain_format.sized_bytes import bytes32, bytes48
from xxch.types.clvm_cost import CLVMCost
from xxch.types.coin_record import CoinRecord
from xxch.types.fee_rate import FeeRate
from xxch.types.mempool_inclusion_status import MempoolInclusionStatus
from xxch.types.mempool_item import BundleCoinSpend, MempoolItem
from xxch.types.spend_bundle import SpendBundle
from xxch.types.spend_bundle_conditions import SpendBundleConditions
from xxch.util import cached_bls
from xxch.util.cached_bls import LOCAL_CACHE
from xxch.util.condition_tools import pkm_pairs
from xxch.util.db_wrapper import SQLITE_INT_MAX
...
class MempoolManager:
    ...
    def __init__(
        ...
        *,
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 XXCH per block, or about 0.00005 XXCH for two
        # spends.
