...
from xxch.plotting.util import PlotInfo, parse_plot_info
from xxch.protocols import harvester_protocol
from xxch.protocols.farmer_protocol import FarmingInfo
from xxch.protocols.harvester_protocol import Plot, PlotSyncResponse
...
from xxch.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSXxchConnection
    ) -> None:
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSXxchConnection
    ) -> None:
        """
