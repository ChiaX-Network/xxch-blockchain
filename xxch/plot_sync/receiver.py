...
from xxch.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR, _expected_plot_size
from xxch.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from xxch.plot_sync.exceptions import (
...
from xxch.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
from xxch.plotting.util import HarvestingMode
...
from xxch.server.outbound_message import make_msg
from xxch.server.ws_connection import WSXxchConnection
from xxch.types.blockchain_format.sized_bytes import bytes32
from xxch.util.ints import int16, uint32, uint64
from xxch.util.misc import get_list_or_len
...
class Receiver:
    ...
    def connection(self) -> WSXxchConnection:
