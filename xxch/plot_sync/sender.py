...
from xxch.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
from xxch.plot_sync.util import Constants
from xxch.plotting.manager import PlotManager
from xxch.plotting.util import HarvestingMode, PlotInfo
...
class Sender:
    ...
    _connection: Optional[WSXxchConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSXxchConnection) -> None:
