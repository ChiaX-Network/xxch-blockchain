"""
NOTE: This contains duplicate code from `xxch.cmds.plots`.
After `xxch plots create` becomes obsolete, consider removing it from there.
"""
...
from xxch.plotting.util import Params, add_plot_directory, validate_plot_size
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Xxch Proof of Space", "version": chiapos_version, "installed": True}


def plot_xxch(args: Namespace, root_path: Path) -> None:
    try:
