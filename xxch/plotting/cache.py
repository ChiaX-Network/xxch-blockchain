...
from xxch.plotting.util import parse_plot_info
from xxch.types.blockchain_format.proof_of_space import generate_plot_public_key
        ...
        try:
            ...
            if stored_cache.version == CURRENT_VERSION:
                ...
                for path, cache_entry in cache_data.entries:
                    ...
                    #       Related: - https://github.com/Chiax-Network/xxch-blockchain/issues/13084
