...
from xxch.data_layer.data_layer_errors import OfferIntegrityError
...
from xxch.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from xxch.rpc.data_layer_rpc_util import marshal
...
from xxch.util.streamable import recurse_jsonify
from xxch.util.ws_message import WsRpcMessage
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "xxch_data_layer"
