...
from xxch.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from xxch.rpc.rpc_client import RpcClient
from xxch.types.blockchain_format.sized_bytes import bytes32
from xxch.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to Xxch RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
