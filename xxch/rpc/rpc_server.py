...
from xxch.rpc.util import wrap_http_handler
from xxch.server.outbound_message import NodeType
from xxch.server.server import XxchServer, ssl_context_for_client, ssl_context_for_server
...
from xxch.util.config import str2bool
from xxch.util.ints import uint16
from xxch.util.json_util import dict_to_json_str
from xxch.util.network import WebServer, resolve
from xxch.util.ws_message import WsRpcMessage, create_payload, create_payload_dict, format_response, pong
...
class RpcServiceProtocol(Protocol):
    ...
    def server(self) -> XxchServer:
        ...
        # a property so as to be read only which allows XxchServer to satisfy
        # Optional[XxchServer]
        ...
    ...
    def get_connections(self, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
        ...
        xxch.rpc.rpc_server.default_get_connections()
        """
        ...
...
def default_get_connections(server: XxchServer, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
