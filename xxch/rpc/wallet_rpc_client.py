...
from xxch.data_layer.data_layer_wallet import Mirror, SingletonRecord
from xxch.pools.pool_wallet_info import PoolWalletInfo
...
class WalletRpcClient(RpcClient):
    """
    Client to Xxch RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    JSON into native python objects before returning. All api calls use POST requests.
    Note that this is not the same as the peer protocol, or wallet protocol (which run Xxch's
    ...
    async def nft_mint_bulk(
        ...
        xxch_coins: Optional[List[Dict]] = None,
        xxch_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "xxch_change_target": xxch_change_target,
