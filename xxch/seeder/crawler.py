...
from xxch.protocols import full_node_protocol
from xxch.protocols.full_node_protocol import RespondPeers
from xxch.rpc.rpc_server import StateChangedProtocol, default_get_connections
from xxch.seeder.crawl_store import CrawlStore
from xxch.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def create_client(
        self, peer_info: PeerInfo, on_connect: Callable[[WSXxchConnection], Awaitable[None]]
    ) -> bool:
    ...
    async def connect_task(self, peer: PeerRecord) -> None:
        ...
        async def peer_action(peer: WSXxchConnection) -> None:
