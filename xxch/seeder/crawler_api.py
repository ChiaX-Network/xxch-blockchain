...
from xxch.protocols import full_node_protocol, wallet_protocol
...
class CrawlerAPI:
    ...
    @api_request(peer_required=True)
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSXxchConnection) -> Optional[Message]:
    ...
    async def new_compact_vdf(
        self, request: full_node_protocol.NewCompactVDF, peer: WSXxchConnection
    ) -> Optional[Message]:
        pass
