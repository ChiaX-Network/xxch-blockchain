...
from xxch.consensus.default_constants import DEFAULT_CONSTANTS, update_testnet_overrides
from xxch.full_node.full_node import FullNode
from xxch.full_node.full_node_api import FullNodeAPI
from xxch.rpc.full_node_rpc_api import FullNodeRpcApi
from xxch.server.outbound_message import NodeType
from xxch.server.start_service import RpcInfo, Service, async_run
from xxch.util.xxch_logging import initialize_service_logging
from xxch.util.config import load_config, load_config_cli
...
from xxch.util.task_timing import maybe_manage_task_instrumentation
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("XXCH_INSTRUMENT_NODE") is not None):
        ...
        if not service_config.get("use_xxch_loop_policy", True):
            target_peer_count = None
