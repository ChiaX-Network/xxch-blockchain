...
from xxch.rpc.wallet_rpc_api import WalletRpcApi
...
async def async_main() -> int:
    ...
    if local_test is True:
        from xxch.simulator.block_tools import test_constants
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("XXCH_INSTRUMENT_WALLET") is not None):
