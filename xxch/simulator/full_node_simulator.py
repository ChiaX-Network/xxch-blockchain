...
from xxch.rpc.rpc_server import default_get_connections
from xxch.server.outbound_message import NodeType
from xxch.simulator.block_tools import BlockTools
from xxch.simulator.simulator_protocol import FarmNewBlockProtocol, GetAllCoinsProtocol, ReorgProtocol
...
from xxch.wallet.util.tx_config import DEFAULT_TX_CONFIG
...
class FullNodeSimulator(FullNodeAPI):
    ...
    async def farm_blocks_to_puzzlehash(
        ...
        is to receive XXCH at an address.
