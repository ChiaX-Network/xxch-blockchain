...
from xxch.cmds.init_funcs import init
...
from xxch.farmer.farmer import Farmer
from xxch.farmer.farmer_api import FarmerAPI
...
from xxch.harvester.harvester_api import HarvesterAPI
from xxch.introducer.introducer import Introducer
from xxch.introducer.introducer_api import IntroducerAPI
from xxch.protocols.shared_protocol import Capability, capabilities
from xxch.seeder.crawler import Crawler
from xxch.seeder.crawler_api import CrawlerAPI
from xxch.seeder.dns_server import DNSServer, create_dns_server_service
from xxch.seeder.start_crawler import create_full_node_crawler_service
from xxch.server.outbound_message import NodeType
from xxch.server.start_farmer import create_farmer_service
from xxch.server.start_full_node import create_full_node_service
from xxch.server.start_harvester import create_harvester_service
from xxch.server.start_introducer import create_introducer_service
from xxch.server.start_service import Service
from xxch.server.start_timelord import create_timelord_service
from xxch.server.start_wallet import create_wallet_service
from xxch.simulator.block_tools import BlockTools, test_constants
from xxch.simulator.full_node_simulator import FullNodeSimulator
from xxch.simulator.keyring import TempKeyring
from xxch.simulator.ssl_certs import get_next_nodes_certs_and_keys, get_next_private_ca_cert_and_key
from xxch.simulator.start_simulator import create_full_node_simulator_service
from xxch.ssl.create_ssl import create_all_ssl
from xxch.timelord.timelord import Timelord
from xxch.timelord.timelord_api import TimelordAPI
from xxch.timelord.timelord_launcher import VDFClientProcessMgr, find_vdf_client, spawn_process
from xxch.types.blockchain_format.sized_bytes import bytes32
from xxch.types.peer_info import UnresolvedPeerInfo
from xxch.util.bech32m import encode_puzzle_hash
from xxch.util.config import config_path_for_filename, load_config, lock_and_load_config, save_config, set_peer_info
from xxch.util.db_wrapper import generate_in_memory_db_uri
from xxch.util.ints import uint16
from xxch.util.keychain import bytes_to_mnemonic
from xxch.util.lock import Lockfile
from xxch.util.misc import SignalHandlers
from xxch.wallet.wallet_node import WalletNode
from xxch.wallet.wallet_node_api import WalletNodeAPI
...
async def setup_crawler(
    ...
    service_config["other_peers_port"] = 22988
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["xxch_spam_amount"] = xxch_spam_amount
...
async def setup_farmer(
    ...
    service_config["xxch_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "xxch")
    service_config["pool_public_keys"] = [bytes(pk).hex() for pk in b_tools.pool_pubkeys]
    service_config["port"] = port
    service_config["rpc_port"] = uint16(0)
    config_pool["xxch_target_address"] = encode_puzzle_hash(b_tools.pool_ph, "xxch")
