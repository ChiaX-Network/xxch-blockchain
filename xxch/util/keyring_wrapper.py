...
from xxch.util.default_root import DEFAULT_KEYS_ROOT_PATH
from xxch.util.file_keyring import FileKeyring
...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ xxch passphrase set # all the cool kids are doing it!"

MASTER_PASSPHRASE_SERVICE_NAME = "Xxch Passphrase"
MASTER_PASSPHRASE_USER_NAME = "Xxch Passphrase"
...
class KeyringWrapper:
    ...
    def _get_initial_cached_passphrase(self) -> str:
        ...
        """
        from xxch.util.keychain import supports_os_passphrase_storage
