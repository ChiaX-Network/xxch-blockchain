...
from xxch.util.condition_tools import conditions_dict_for_solution
...
CAT_MOD = load_clvm_maybe_recompile("cat_v2.clsp", package_or_requirement="xxch.wallet.cat_wallet.puzzles")
