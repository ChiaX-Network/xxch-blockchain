...
from xxch.wallet.derive_keys import master_sk_to_wallet_sk_unhardened
from xxch.wallet.did_wallet import did_wallet_puzzles
from xxch.wallet.did_wallet.did_info import DIDCoinData, DIDInfo
from xxch.wallet.did_wallet.did_wallet_puzzles import match_did_puzzle, uncurry_innerpuz
...
class DIDWallet:
    ...
    async def coin_added(self, coin: Coin, _: uint32, peer: WSXxchConnection, parent_coin_data: Optional[DIDCoinData]):
    ...
    async def create_update_spend(
        ...
        if xxch_tx is not None and xxch_tx.spend_bundle is not None:
            ...
            await self.wallet_state_manager.add_pending_transaction(xxch_tx)
