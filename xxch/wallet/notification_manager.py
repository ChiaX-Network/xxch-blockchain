...
from xxch.wallet.notification_store import Notification, NotificationStore
from xxch.wallet.transaction_record import TransactionRecord
from xxch.wallet.util.compute_memos import compute_memos_for_spend
from xxch.wallet.util.notifications import construct_notification
...
class NotificationManager:
    ...
    async def send_new_notification(
        ...
        full_tx: TransactionRecord = dataclasses.replace(
            xxch_tx, spend_bundle=SpendBundle.aggregate([xxch_tx.spend_bundle, extra_spend_bundle])
        )
        return full_tx
