...
from xxch.wallet.puzzles.clawback.puzzle_decorator import ClawbackPuzzleDecorator
from xxch.wallet.puzzles.stake.puzzle_decorator import StakePuzzleDecorator
