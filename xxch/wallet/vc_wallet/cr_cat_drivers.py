...
from xxch.wallet.puzzles.singleton_top_layer_v1_1 import SINGLETON_LAUNCHER_HASH, SINGLETON_MOD_HASH
from xxch.wallet.uncurried_puzzle import UncurriedPuzzle, uncurry_puzzle
from xxch.wallet.util.curry_and_treehash import curry_and_treehash
from xxch.wallet.vc_wallet.vc_drivers import (
    COVENANT_LAYER_HASH,
...
CREDENTIAL_RESTRICTION: Program = load_clvm_maybe_recompile(
    ...
    package_or_requirement="xxch.wallet.vc_wallet.cr_puzzles",
