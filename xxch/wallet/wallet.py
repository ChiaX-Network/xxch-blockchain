...
from xxch.wallet.puzzles.clawback.metadata import ClawbackMetadata
...
from xxch.wallet.puzzles.puzzle_utils import (
...
class Wallet:
    ...
    # WSXxchConnection is only imported for type checking
