...
from xxch.wallet.singleton import get_inner_puzzle_from_singleton, get_singleton_id_from_puzzle
from xxch.wallet.singleton_record import SingletonRecord
